...
(function (CATMAID) {
  ...
  ProofreadSkeletonVisualizationLayer.prototype.update = function () {
    ...
    if (!self.currentResult) {
      ...
      self.getArborParser (self.currentResult).then (ap => {
  ...
  ProofreadSkeletonVisualizationLayer.prototype._createProjection = function (
    ...
    var downstreamColor = this.options.downstreamColor;
    ...
    var renderOptions = {
      ...
      edgeWidth: this.graphics.Node.prototype.EDGE_WIDTH || 10,
      ...
      if (this.showEdges) {
        ...
        if (e) {
          ...
          var color = this.color (
            n,
            pos2,
            (pos2[this.normalDim] + pos[this.normalDim])/2
          );
  ...
  ProofreadSkeletonVisualizationLayer.shadingModes = {
    ...
    skeletoncolorgradient: {
      ...
      color: function (layer, color) {
        ...
        var from = CATMAID.tools.cssColorToRGB (layer.options.close_color);
