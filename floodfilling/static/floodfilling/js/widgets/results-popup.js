...
(function(CATMAID) {
   ...
   */
  ResultsWindow.prototype.show = function(width, height, modal, maxHeight, resize) {
    var self = this;
    var buttons;
    if (this.buttons) {
      buttons = {};
  ...
  ResultsWindow.prototype.appendChoice = function(title, choiceID, names, values, defaultValue) {
  ...
  ResultsWindow.prototype.appendField = function(title, fieldID,
  ...
  ResultsWindow.prototype.appendNumericField = function(title, fieldID,
  ...
  ResultsWindow.prototype.appendCheckbox = function(title, checkboxID, selected, helptext) {
    var p = document.createElement('p');
   ...
   */
  ResultsWindow.prototype.appendSortableTable = function(items, title, paging) {
