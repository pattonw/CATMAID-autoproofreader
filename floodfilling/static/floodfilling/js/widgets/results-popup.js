...
(function (CATMAID) {
   ...
   */
  var ResultsWindow = function (title, buttons, manualDestroy) {
  ...
  ResultsWindow.prototype.show = function (
    ...
    var fallbackMaxHeight = height === 'auto'
      ? Math.floor (CATMAID.ui.getFrameHeight () * 0.66)
      : undefined;
  ...
  ResultsWindow.prototype.appendChild = function (element) {
  ...
  ResultsWindow.prototype.appendHTML = function (html) {
    var container = document.createElement ('p');
  ...
  ResultsWindow.prototype.appendMessage = function (text) {
  ...
  ResultsWindow.prototype.appendChoice = function (
    title,
    choiceID,
    names,
    values,
  ...
  ResultsWindow.prototype.appendField = function (
    title,
    fieldID,
    initialValue,
    submitOnEnter
  ...
  ResultsWindow.prototype.appendNumericField = function (
    title,
    fieldID,
    initialValue,
    min,
  ...
  ResultsWindow.prototype.appendCheckbox = function (
    title,
    checkboxID,
    selected,
    helptext
   ...
   */
  ResultsWindow.prototype.appendSortableTable = function (
    items,
    title,
    paging
  ) {
        ...
        columns: [
          {
            ...
            render: function (data, type, row, meta) {
              var upClasses = meta.row === 0
                ? 'fa fa-caret-up fa-disabled'
                : 'fa fa-caret-up';
              var downClasses = meta.row === items.length - 1
                ? 'fa fa-caret-down fa-disabled'
                : 'fa fa-caret-down';
              return (
                '<i class="' +
                upClasses +
                '" data-action="move-up" title="Move item up in list"></i>' +
                '<i class="' +
                downClasses +
                '" data-action="move-down" title="Move item down in list"></i>'
              );
            },
          },
          {
